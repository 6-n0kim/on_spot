...
사용자들이 특정 위치에서의 경험을 공유하고, 다른 사용자들의 게시물을 탐색하며 소통할 수 있는 서비스입니다.
...
| **UI Library**      | Bootstrap 4.0 / 5.0             |
| **Icons**           | Font Awesome                    |
| **Maps**            | Kakao Maps SDK                  |
| **File Upload**     | COS (Multipart)                 |
| **Server**          | Apache Tomcat                   |
| **Database Driver** | Oracle JDBC Driver (ojdbc6.jar) |
